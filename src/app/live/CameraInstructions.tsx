  ...
  const tips = [
    {
      ...
      text: t("cameraInstructions.tip1"),
    },
    {
      icon: (
        <svg
      ...
      text: t("cameraInstructions.tip2"),
    },
    {
      icon: (
        <svg
      ...
      text: t("cameraInstructions.tip3"),
    },
    {
      icon: (
        <svg
      ...
      text: t("cameraInstructions.tip4"),
    },
  ];
    ...
    <div className="h-full flex flex-col justify-between items-center bg-white py-safe">
      <div className="w-full pt-6 text-center flex flex-1 flex-col">
        <div className="text-lg font-medium flex justify-center">
          <h2 className="text-gray-900 text-lg">{t("cameraInstructions.title")}</h2>
        </div>
